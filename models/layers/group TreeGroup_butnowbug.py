...
def part2_and_count(xyz, FPS_th, TreeDepth):
    ...
    for i in range(2):
        # pdb.set_trace()
        pointNum = torch.nonzero(xyz_0_temp[0,:]==i).size()[1]
        # # xyz_row = (torch.gather(torch.reshape(xyz[b,:], [1,-1,3]), 1, indx))
        xyz_row = xyz.clone()
        xyz_row[(xyz_0_temp[0,:] !=i).reshape([1,-1])] = 5
        xyz_2dList[i] = xyz_row
        size_2dTensor[i] = pointNum
        if pointNum <= FPS_th:
            FPS_2dList[i] = 1
...
def Tree_group_depth10_config(xyz, nsample, new_xyz, radius, group_th):
    B, N, _ = xyz.size()
    ...
    for i in range(0, B): # deep=1
        ...
        size_2dL_L1, xyz_2dL_L1, FPS_2dL_L1 = part2_and_count(xyz[i, :, :].unsqueeze(0),group_th, 0)
        for j in range(0, 2):
            if (size_2dL_L1[j] != 0):
                xyz_L1 = xyz_2dL_L1[j]
                if (FPS_2dL_L1[j]==1):
                    ...
                    size_2dL_L2, xyz_2dL_L2, FPS_2dL_L2 = part2_and_count(xyz_L1, group_th, 1)
                    for k in range(0, 2):
                        if (size_2dL_L2[k] != 0):
                            xyz_L2 = xyz_2dL_L2[k]
                            if (FPS_2dL_L2[k]==1):
                                ...
                                size_2dL_L3, xyz_2dL_L3, FPS_2dL_L3 = part2_and_count(xyz_L2, group_th, 2) # actually the FPS_th2 is useless here
                                for l in range(0, 2):
                                    if (size_2dL_L3[l] != 0):
                                        xyz_L3 = xyz_2dL_L3[l]
                                        if (FPS_2dL_L3[l]==1):
                                            ...
                                            size_2dL_L4, xyz_2dL_L4, FPS_2dL_L4 = part2_and_count(xyz_L3, group_th, 3) # actually the FPS_th2 is useless here
                                            for m in range(0, 2):
                                                if (size_2dL_L4[m]==1):
                                                    xyz_L4 = xyz_2dL_L4[m]
                                                    if (FPS_2dL_L4[m]==1):
                                                        ...
                                                        size_2dL_L5, xyz_2dL_L5, FPS_2dL_L5 = part2_and_count(xyz_L4, group_th, 4) # actually the FPS_th2 is useless here
                                                        for n in range(0, 2):
                                                            if (size_2dL_L5[n]==1):
                                                                xyz_L5 = xyz_2dL_L5[n]
                                                                if (FPS_2dL_L5[n]==1):
                                                                    ...
                                                                    size_2dL_L6, xyz_2dL_L6, FPS_2dL_L6 = part2_and_count(xyz_L5, group_th, 5) # actually the FPS_th2 is useless here
                                                                    for o in range(0, 2):
                                                                        if (size_2dL_L6[o] != 0):
                                                                            xyz_L6 = xyz_2dL_L6[o]
                                                                            if (FPS_2dL_L6[o]==1):
                                                                                ...
                                                                                size_2dL_L7, xyz_2dL_L7, FPS_2dL_L7 = part2_and_count(xyz_L6,group_th,6) # actually the FPS_th2 is useless here
                                                                                for p in range(0, 2):
                                                                                    if (size_2dL_L7[p] != 0):
                                                                                        xyz_L7 = xyz_2dL_L7[p]
                                                                                        if (FPS_2dL_L7[p]==1):
                                                                                            ...
                                                                                            size_2dL_L8, xyz_2dL_L8, FPS_2dL_L8 = part2_and_count(xyz_L7,group_th,7) # actually the FPS_th2 is useless here
                                                                                            for q in range(0, 2):
                                                                                                if (size_2dL_L8[q] != 0):
                                                                                                    xyz_L8 = xyz_2dL_L8[q]
                                                                                                    if (FPS_2dL_L8[q]==1):
                                                                                                        ...
                                                                                                        size_2dL_L9, xyz_2dL_L9, FPS_2dL_L9 = part2_and_count(xyz_L8, group_th,8) # actually the FPS_th2 is useless here
                                                                                                        for r in range(0, 2):
                                                                                                            if (size_2dL_L9[r] != 0):
                                                                                                                xyz_L9 = xyz_2dL_L9[r]
                                                                                                                if (FPS_2dL_L9[r]==1):
                                                                                                                    ...
                                                                                                                    size_2dL_L10, xyz_2dL_L10, FPS_2dL_L10 = part2_and_count(xyz_L9, group_th,9) # actually the FPS_th2 is useless here
                                                                                                                    for s in range(0, 2):
                                                                                                                        if (size_2dL_L10[s] != 0):
